...
*/
		...
		matchHolder.home_team_img.setImageResource(Utils.getTeamFlagResource(match.getHome().getId()));
		matchHolder.home_team_name.setText(match.getHome().getName().toString());

		matchHolder.away_team_img.setImageResource(Utils.getTeamFlagResource(match.getAway().getId()));
