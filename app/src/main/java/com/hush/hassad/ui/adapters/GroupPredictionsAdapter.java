...
public class GroupPredictionsAdapter extends ArrayAdapter {
	...
	public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
		...
		groupHolder.checkBox2 = (CheckBox) predictedTeam1.findViewById(R.id.team_selected);
		groupHolder.checkBox2.setVisibility(View.GONE);
		groupHolder.checkBox3 = (CheckBox) predictedTeam1.findViewById(R.id.team_selected);
		groupHolder.checkBox3.setVisibility(View.GONE);
		groupHolder.checkBox4 = (CheckBox) predictedTeam1.findViewById(R.id.team_selected);
		groupHolder.checkBox4.setVisibility(View.GONE);

		GroupPrediction groupPrediction = groups.get(position);

		groupHolder.predictedGroupNum.setText(groupPrediction.getPredicted_result().getGroup().getName().toString());
		...
		String team1 = groupPrediction.getPredicted_result().getGroup().getTeams().get(0).toString();
		String team2 = groupPrediction.getPredicted_result().getGroup().getTeams().get(1).toString();
		String team3 = groupPrediction.getPredicted_result().getGroup().getTeams().get(2).toString();
		String team4 = groupPrediction.getPredicted_result().getGroup().getTeams().get(3).toString();
		String qualifying1 = groupPrediction.getPredicted_result().getQualifying_1().toString();
		String qualifying2 = groupPrediction.getPredicted_result().getQualifying_2().toString();
		...
		if(!team1.equals(qualifying1) || !team1.equals(qualifying2))
			t3 = team1;
		else if(!team2.equals(qualifying1) || !team1.equals(qualifying2))
			t3 = team2;
		else if(!team3.equals(qualifying1)|| !team1.equals(qualifying2))
			t3 = team3;
		else if(!team4.equals(qualifying1)|| !team1.equals(qualifying2))
			t3 = team4;

		if(!team1.equals(qualifying1) || !team1.equals(qualifying2) || !team1.equals(t3))
			t4 = team1;
		else if(!team2.equals(qualifying1) || !team1.equals(qualifying2) || !team1.equals(t3))
			t4 = team2;
		else if(!team3.equals(qualifying1)|| !team1.equals(qualifying2) || !team1.equals(t3))
			t4 = team3;
		else if(!team4.equals(qualifying1)|| !team1.equals(qualifying2) || !team1.equals(t3))
			t4 = team4;

		groupHolder.team3Img.setImageResource(R.drawable.manchester_united);
		groupHolder.team3Name.setText(t4);
